...
const LoginForm = (): JSX.Element => {
    ...
    return (
        <div className={'bg-gradient-to-r from-blue-400 to-green-400 flex justify-center items-center w-screen h-screen'}>
            <div className={'hidden md:block mx-20 mb-16'}>
                <img className={'rounded-2xl shadow-xl w-60 h-60 object-cover object-center'} src="https://images.unsplash.com/photo-1674058195059-d71ab5223b9f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzMXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60" alt=""/>
            </div>
            <fieldset className={'bg-gray-100 mb-16 px-10 h-60 rounded-2xl shadow-xl'}>
                <h1 className={'text-2xl font-bold mt-8 mb-2 text-center text-blue-500'}>Login to Application</h1>
                <div>
                    <form className={'mt-4'} onSubmit={formSubmitHandler}>
                        <div className={'my-2'}>
                            <label className={'flex justify-center'} htmlFor={'username_input'}>
                                <span className={'mx-auto text-2xl text-blue-500'}><AiOutlineUser/></span>
                        ...
                        <div className={'my-2 focus:bg-red-300'}>
                            <label className={'flex justify-center'} htmlFor={'password_input'}>
                                <span className={'mx-auto text-2xl text-blue-500'}><AiOutlineKey/></span>
                                <input className={''} id={'password_input'} type={'password'} value={password} placeholder={'Password'}
                                       onChange={passwordChangeHandler}/>
                            </label>
                        </div>
                        <button
                            className={'block border-2 px-3 border-blue-500 bg-blue-500 text-gray-100 hover:bg-blue-500 rounded-2xl mx-auto mt-6'}
